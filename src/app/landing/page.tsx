  ...
  return (
    <main className="min-h-screen bg-void-black relative overflow-hidden">
      ...
      <div className="relative z-10 pt-20">
        ...
        <section className="min-h-[80vh] flex items-center justify-center px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="text-void-muted-dark text-sm md:text-base mb-12 max-w-3xl mx-auto leading-relaxed space-y-4">
              <p>
                In the digital noise of our modern world, we create pockets of
                silence. Here, thoughts breathe, ideas crystallize, and
                consciousness finds its voice.
              </p>
              <p>
        ...
        {/* About Section */}
        <section className="py-20 px-6 border-t border-void-border/30">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex justify-center mb-8">
              <Sparkles size={32} className="text-void-accent animate-pulse" />
            </div>

            <h2 className="text-2xl md:text-3xl font-light text-void-text mb-6">
              About the <span className="text-void-accent">Void</span>
            </h2>
            ...
            <div className="text-void-muted leading-relaxed space-y-6 max-w-3xl mx-auto">
              ...
              <p>
                Each post is a journey into the depths of thought, crafted with
                intention and shared with those who seek meaning in the digital
                age.
              </p>
        ...
        <footer className="py-12 px-6 border-t border-void-border/20">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-void-accent to-void-accent-light flex items-center justify-center">
                <div className="w-2 h-2 rounded-full bg-void-black"></div>
              </div>
              <span className="text-void-muted font-medium">void space</span>
            </div>
